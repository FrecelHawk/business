...
/**
 * @ClassName: RadioGroupCompound
 * @Description: TODO   有CompoundButton的ID冲突。暂时不解决
 * @author FH 
 * @date 2015年7月27日 下午5:10:22
 * 
*/

public class RadioGroupCompound extends LinearLayout {
	...
	public RadioGroupCompound(Context context) {
		 super(context);
	     init();
	}
    
    public RadioGroupCompound(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private List<CompoundButton> findCheckedView(View child) {
		...
		if (child instanceof CompoundButton) {
			...
			for (int i = 0, j = group.getChildCount(); i < j; i++) {
				List<CompoundButton> allChildCompoundButtonList = findCheckedView(group
						.getChildAt(i));
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new RadioGroupCompound.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof RadioGroupCompound.LayoutParams;
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(RadioGroupCompound group, int checkedId);
    }
    ...
    public void onChildViewAdded(View parent, View child) {
            if (parent == RadioGroupCompound.this) {
                List<CompoundButton> list = findCheckedView(child);//查找子控件
                for (CompoundButton view : list) {
                	 if (view != null) {
                         int id = view.getId();
